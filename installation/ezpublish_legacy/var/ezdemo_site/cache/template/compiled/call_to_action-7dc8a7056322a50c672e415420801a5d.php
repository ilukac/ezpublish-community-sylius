...
// Filename:  extension/ezdemo/design/ezdemo/override/templates/block_item/call_to_action.tpl
// Timestamp: 1437211071 (Sat Jul 18 11:17:51 CEST 2015)
$oldSetArray_23281058f6cf3d425802522ff54e64a5 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '" class="btn btn-warning pull-right">';
// if begins
unset( $if_cond );
unset( $if_cond );
...
unset( $if_cond );
$if_cond = $if_cond1;
$if_cond1 = compiledFetchAttribute( $if_cond, 'action_button_label' );
unset( $if_cond );
$if_cond = $if_cond1;
...
unset( $var1 );
$var1 = $var2;
$var2 = compiledFetchAttribute( $var1, 'action_button_label' );
unset( $var1 );
$var1 = $var2;
...
$setArray = $oldSetArray_23281058f6cf3d425802522ff54e64a5;
$tpl->Level--;
?>
