...
$oldSetArray_33c0ceebf6c855b8d3a990f307bc653f = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form action="/administration/content/search" method="get">
    ';
// if begins
unset( $if_cond );
unset( $if_cond );
...
{
$text .= '            <p class="advanced hide"><a href="/administration/content/advancedsearch" title="Advanced search.">Advanced</a></p>
        ';
}
unset( $if_cond );
// if ends
...
unset( $var1 );
unset( $var1 );
$var1 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'search_node_id', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['search_node_id'] : null;
if (! isset( $var1 ) ) $var1 = NULL;
while ( is_object( $var1 ) and method_exists( $var1, 'templateValue' ) )
    $var1 = $var1->templateValue();
while ( is_object( $var1 ) and method_exists( $var1, 'templateValue' ) )
...
$setArray = $oldSetArray_33c0ceebf6c855b8d3a990f307bc653f;
$tpl->Level--;
?>
