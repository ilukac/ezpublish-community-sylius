...
$oldSetArray_bf4800f00ec73c242501286361bcd29f = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<form name="translationsform" method="post" action="/administration/content/translation">
...
<fieldset>
<legend>Existing translations</legend>

<table id="tab-translations-list" class="list" cellspacing="0" summary="Language list of translations for current object.">
<tr>
    <th class="tight"><img src="/design/admin/images/toggle-button-16x16.gif" width="16" height="16" alt="Invert selection." title="Invert selection." onclick="ezjs_toggleCheckboxes( document.translationsform, \'LanguageID[]\' ); return false;"/></th>
    <th>Language</th>
    <th>Locale</th>
...
$text .= '" title="Use these radio buttons to select the desired main language." />
';
}
unset( $if_cond );
// if ends
...
$var1 = strtr( 'Edit in <%language_name>.', $var4 );
...
if ( $if_cond )
{
$text .= '    <input class="button" type="submit" name="RemoveTranslationButton" value="Remove selected" title="Remove selected languages from the list above." />
    ';
}
else
{
$text .= '    <input class="button-disabled" type="submit" name="RemoveTranslationButton" value="Remove selected" title="There is no removable language." disabled="disabled" />
    ';
}
unset( $if_cond );
// if ends
...
{
$text .= '    <input class="button-disabled" type="submit" name="RemoveTranslationButton" value="Remove selected" disabled="disabled" title="You cannot remove any language because you do not have permission to edit the current item." />';
}
unset( $if_cond );
// if ends
...
if ( $if_cond )
{
$text .= '    <input id="tab-translations-list-set-main" class="button" type="submit" name="UpdateInitialLanguageButton" value="Set main" title="Select the desired main language using the radio buttons above then click this button to store the setting." />
...
{
$text .= '    <input class="button-disabled" type="submit" name="UpdateInitialLanguageButton" value="Set main" disabled="disabled" title="You cannot change the main language because the object is not translated to any other languages." />
    ';
}
unset( $if_cond );
// if ends
...
{
$text .= '    <input class="button-disabled" type="submit" name="UpdateInitialLanguageButton" value="Set main" disabled="disabled" title="You cannot change the main language because you do not have permission to edit the current item." />';
}
unset( $if_cond );
// if ends
...
$text .= ' /> Use the main language if there is no prioritized translation.
</div>
...
if ( $if_cond )
{
$text .= '    <input id="tab-translations-alwaysavailable-btn" class="button" type="submit" name="UpdateAlwaysAvailableButton" value="Update" title="Use this button to store the value of the checkbox above." />
    <script type="text/javascript">
...
{
$text .= '    <input class="button-disabled" disabled="disabled" type="submit" name="UpdateAlwaysAvailableButton" value="Update" title="You do not have permission to change this setting." />';
}
unset( $if_cond );
// if ends
...
$setArray = $oldSetArray_bf4800f00ec73c242501286361bcd29f;
$tpl->Level--;
?>
