...
$oldSetArray_da5e3ed72df87987ecb5f784ac230cae = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$subtreeExpiry = NULL;
$cacheKeys = array( $cacheKeys, "47_0_47_194_design/admin/templates/pagelayout.tpl", "administration" );
...
$textStack[] = $text;
$text = '';
$oldRestoreIncludeArray_11cfe06202cfa54c9f68bcc5893b1f93 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_head-26ae43736690def531e158979ffd26ff.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_head-26ae43736690def531e158979ffd26ff.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_11cfe06202cfa54c9f68bcc5893b1f93;

$oldRestoreIncludeArray_eebdca64ea0f0ae9ae878dbe10224853 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_head_style-d91ed5c7914e1903b578fac960ed76c9.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_head_style-d91ed5c7914e1903b578fac960ed76c9.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_eebdca64ea0f0ae9ae878dbe10224853;

$oldRestoreIncludeArray_e60f29d50d0b73be111ffaef0d25ba95 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_head_script-2ddeb8729f8585a2a20806264941a873.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_head_script-2ddeb8729f8585a2a20806264941a873.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_e60f29d50d0b73be111ffaef0d25ba95;
...
';
$oldRestoreIncludeArray_78480f0917223428471294a77e70c2fe = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_header-8cc4dbfaa66c0d35619f47cd5d13710b.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_header-8cc4dbfaa66c0d35619f47cd5d13710b.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_78480f0917223428471294a77e70c2fe;
...
$subtreeExpiry = NULL;
$cacheKeys = array( $cacheKeys, "66_0_66_174_design/admin/templates/pagelayout.tpl", "administration" );
...
$text .= '
';
$oldRestoreIncludeArray_8751b59ac2d7ff3b2f95d0a9c3c3a7a7 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_topmenu-c2bf5e10e438b1737c40b3b8cd61d9c8.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_topmenu-c2bf5e10e438b1737c40b3b8cd61d9c8.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_8751b59ac2d7ff3b2f95d0a9c3c3a7a7;
...
if ( $if_cond )
{
$text .= '    <a id="rightmenu-showhide" class="show-hide-control" title="Show / Hide rightmenu" href="/administration/user/preferences/set/admin_right_menu_show/1"></a>
    <div id="rightmenu-design"></div>';
}
else
{
$text .= '    <a id="rightmenu-showhide" class="show-hide-control" title="Hide / Show rightmenu" href="/administration/user/preferences/set/admin_right_menu_show/0"></a>
    <div id="rightmenu-design">
        ';
$oldRestoreIncludeArray_14027eec62246cc0318e232dd7385939 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/admin_current_user-91ca1c12ea612cfb064b7bdf177ab9e9.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/admin_current_user-91ca1c12ea612cfb064b7bdf177ab9e9.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_14027eec62246cc0318e232dd7385939;

$oldRestoreIncludeArray_150c32ce252e6f09e6636e676a818bf1 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/admin_preferences-78c4345a2db8d7258788aafc27211742.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/admin_preferences-78c4345a2db8d7258788aafc27211742.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_150c32ce252e6f09e6636e676a818bf1;

$oldRestoreIncludeArray_fe964e560ce8f92c875c10cb2e2efd69 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/admin_bookmarks-6201f71cbfec4171dab49375464505a1.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/admin_bookmarks-6201f71cbfec4171dab49375464505a1.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_fe964e560ce8f92c875c10cb2e2efd69;

$text .= '        ';
$oldRestoreIncludeArray_f26eb349d99c1a0b12a8d293121e30d2 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/admin_clear_cache-5458d3373a623602be223a55601e6964.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/admin_clear_cache-5458d3373a623602be223a55601e6964.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_f26eb349d99c1a0b12a8d293121e30d2;

$oldRestoreIncludeArray_8531c4d59eb74b2801491668251149f6 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/admin_quick_settings-0c90e4d1769b7b608781aaf897d9507a.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/admin_quick_settings-0c90e4d1769b7b608781aaf897d9507a.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_8531c4d59eb74b2801491668251149f6;
...
$subtreeExpiry = NULL;
$cacheKeys = array( $cacheKeys, "148_0_148_161_design/admin/templates/pagelayout.tpl", "administration" );
...
{
$text .= '    ';
$oldRestoreIncludeArray_1abd1b447317a444634ed29822c414b5 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_leftmenu-df07b7383fa28df647f16ac1620b43d2.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_leftmenu-df07b7383fa28df647f16ac1620b43d2.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_1abd1b447317a444634ed29822c414b5;
...
{
$text .= '    ';
$oldRestoreIncludeArray_a83affd967473179882b1503c7cd06dc = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_mainarea-f0c0d09faca8307b89445ff4ded1bbb8.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_mainarea-f0c0d09faca8307b89445ff4ded1bbb8.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_a83affd967473179882b1503c7cd06dc;
...
$text .= '    <div id="maincontent">
    ...
    <div id="path">
        <div id="path-design">
            ';
$oldRestoreIncludeArray_3bdf5f861676ea6a0be61eb7b13c6613 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_toppath-877aa810ebf7f58dde7c53adb3c1faec.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_toppath-877aa810ebf7f58dde7c53adb3c1faec.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_3bdf5f861676ea6a0be61eb7b13c6613;
...
$text .= '        </div>
    ...
    <!-- Maincontent START -->
    ';
$oldRestoreIncludeArray_d44d350cda8549a25cb7354e28eaff28 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$restoreIncludeArray = $oldRestoreIncludeArray_d44d350cda8549a25cb7354e28eaff28;
...
$subtreeExpiry = NULL;
$cacheKeys = array( $cacheKeys, "191_0_191_60_design/admin/templates/pagelayout.tpl", "administration" );
...
<div id="footer-design">
    ';
$oldRestoreIncludeArray_0ccf3da4ec154dd23555e659fec5b403 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/page_copyright-6bacda7ba93f4afd41fb9c1d632de443.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/page_copyright-6bacda7ba93f4afd41fb9c1d632de443.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_0ccf3da4ec154dd23555e659fec5b403;
...
';
$oldRestoreIncludeArray_0aedebf93a762cbeea13a262b7f4b6ba = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/popup_menu-392ad872c060556fc10b5394dee94c1e.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/popup_menu-392ad872c060556fc10b5394dee94c1e.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_0aedebf93a762cbeea13a262b7f4b6ba;
...
$setArray = $oldSetArray_da5e3ed72df87987ecb5f784ac230cae;
$tpl->Level--;
?>
