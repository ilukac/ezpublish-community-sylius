...
$oldSetArray_bda518d81370daa4280c6505f73f6da6 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= ']</span> The information could not be collected.</h2>
...
$setArray = $oldSetArray_bda518d81370daa4280c6505f73f6da6;
$tpl->Level--;
?>
