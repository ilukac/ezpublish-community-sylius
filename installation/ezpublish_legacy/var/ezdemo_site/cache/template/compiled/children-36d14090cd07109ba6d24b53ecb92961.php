...
$oldSetArray_5715c81581577904efe09bc5e8496d24 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form name="children" method="post" action="/administration/content/action">
...
$text .= ' title="Up one level."><img src="/design/admin/images/up-16x16-grey.png" width="16" height="16" alt="Up one level." title="Up one level." /></a>&nbsp;';
unset( $var );
unset( $var2 );
unset( $var3 );
unset( $var3 );
...
$text .= '
    ...
    ';
$oldRestoreIncludeArray_71fc2030dc7201af0db67c39a53ab8d6 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/children_detailed-20ed1afb9fcef2633e7d85fca250730d.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/children_detailed-20ed1afb9fcef2633e7d85fca250730d.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_71fc2030dc7201af0db67c39a53ab8d6;
...
$text .= '
    ...
    <div class="context-toolbar">
    ';
$oldRestoreIncludeArray_1c1568f12dd0c72511e32eb6f804fed7 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/alphabetical-2034436e72240d83dbe47f7838c83315.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
...
include( '' . 'var/ezdemo_site/cache/template/compiled/alphabetical-2034436e72240d83dbe47f7838c83315.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_1c1568f12dd0c72511e32eb6f804fed7;
...
$setArray = $oldSetArray_5715c81581577904efe09bc5e8496d24;
$tpl->Level--;
?>
