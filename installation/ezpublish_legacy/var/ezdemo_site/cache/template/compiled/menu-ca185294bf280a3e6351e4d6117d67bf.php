...
$oldSetArray_4947b3358d24f30b8bb393a29cdaa080 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<div id="contentstructure">
    ';
$oldRestoreIncludeArray_35fc032e68899a9d979b3f71bc7072e6 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/content_structure_menu_dynamic-8f55b0fb962cdc1a1b911f059f81a761.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/content_structure_menu_dynamic-8f55b0fb962cdc1a1b911f059f81a761.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_35fc032e68899a9d979b3f71bc7072e6;
...
$text .= ' title="View and manage the contents of the trash bin."><img src="/design/admin/images/trash-icon-16x16.gif" width="16" height="16" alt="Trash" />&nbsp;<span>Trash</span></a>
</div>';
}
unset( $if_cond );
// if ends
...
';
$oldRestoreIncludeArray_baa459685380cca99670370f25a47dfe = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/ini_menu-36017244ec732ebf401e63d1589d2f67.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/ini_menu-36017244ec732ebf401e63d1589d2f67.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_baa459685380cca99670370f25a47dfe;
...
$setArray = $oldSetArray_4947b3358d24f30b8bb393a29cdaa080;
$tpl->Level--;
?>
