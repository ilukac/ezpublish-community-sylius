...
// Filename:  extension/ezdemo/design/ezdemo/override/templates/block/tag_cloud.tpl
// Timestamp: 1437211071 (Sat Jul 18 11:17:51 CEST 2015)
$oldSetArray_c9ec3025d21a4741613bd9188c05090d = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '<div class="block-type-tagcloud block-view-';
unset( $var );
unset( $var );
...
unset( $if_cond1 );
$if_cond1 = $if_cond2;
$if_cond2 = compiledFetchAttribute( $if_cond1, 'subtree_node_id' );
unset( $if_cond1 );
$if_cond1 = $if_cond2;
...
$setArray = $oldSetArray_c9ec3025d21a4741613bd9188c05090d;
$tpl->Level--;
?>
