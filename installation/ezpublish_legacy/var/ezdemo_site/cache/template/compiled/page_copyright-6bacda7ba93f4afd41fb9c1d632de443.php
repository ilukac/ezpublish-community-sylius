...
$oldSetArray_7dff4a8ee1dfdcd1676146f2f03e3671 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$var2 = array( '%edition' => $var3, '%about_link' => "\"/administration/ezinfo/about\"" );unset( $var3 );
...
$var = strtr( '<a href="%evaluate_link">Evaluate eZ Publish Enterprise Edition</a> - <a href="%share_link">Become a member of the eZ Community, exchange and contribute</a>. <a href="%ezpublish_link">eZ Publish</a> Copyright &copy; 1999-2014 <a href="%ez_link">eZ Systems AS</a> and others.', $var3 );
unset( $var2, $var3, $var4, $var5 );
if (! isset( $var ) ) $var = NULL;
while ( is_object( $var ) and method_exists( $var, 'templateValue' ) )
    $var = $var->templateValue();
...
$setArray = $oldSetArray_7dff4a8ee1dfdcd1676146f2f03e3671;
$tpl->Level--;
?>
