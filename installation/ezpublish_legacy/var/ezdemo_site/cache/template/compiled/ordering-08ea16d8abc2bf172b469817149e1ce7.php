...
$oldSetArray_dc8350cabfe05c3fb02fe2f96ae17dc5 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<form name="ordering" method="post" action="/administration/content/action">
...
$setArray = $oldSetArray_dc8350cabfe05c3fb02fe2f96ae17dc5;
$tpl->Level--;
?>
