...
$oldSetArray_b65e9c4014e1448ca6610c8125342c43 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '><span class="text">&laquo;&nbsp;Previous</span></a></span>
       ';
    } break;
    default:
    {
$text .= '      <span class="previous"><span class="text disabled">&laquo;&nbsp;Previous</span></span>
       ';
    } break;
}
unset( $match );
...
$text .= '><span class="text">Next&nbsp;&raquo;</span></a></span>
      ';
    } break;
    default:
    {
$text .= '        <span class="next"><span class="text disabled">Next&nbsp;&raquo;</span></span>
      ';
    } break;
}
unset( $match );
...
$setArray = $oldSetArray_b65e9c4014e1448ca6610c8125342c43;
$tpl->Level--;
?>
