...
$oldSetArray_406f6536c26b2c375258f259d55b209c = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
menuArray[\'Advanced\'][\'elements\'][\'menu-hide\'] = { \'url\': "/administration/content/hide/%nodeID%" };
menuArray[\'Advanced\'][\'elements\'][\'menu-list\'] = { \'url\': "/administration/content/view/sitemap/%nodeID%" };
menuArray[\'Advanced\'][\'elements\'][\'reverse-related\'] = { \'url\': "/administration/content/reverserelatedlist/%nodeID%" };
menuArray[\'Advanced\'][\'elements\'][\'menu-history\'] = { \'url\': "/administration/content/history/%objectID%" };
menuArray[\'Advanced\'][\'elements\'][\'menu-url-alias\'] = { \'url\': "/administration/content/urlalias/%nodeID%" };
</script>
...
<form id="menu-form-swap" method="post" action="/administration/content/action">
...
$setArray = $oldSetArray_406f6536c26b2c375258f259d55b209c;
$tpl->Level--;
?>
