...
$oldSetArray_86897881ffb63d8a5394dc55abb19d58 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form name="loginform" method="post" action="/administration/user/login">
...
<div class="block">
    ...
    <div class="login-text-wrapper">
        or
        <br/>
        <a href="/administration/user/register">Register new account</a>
    </div>
</div>
</div></div>
</div>
...
$setArray = $oldSetArray_86897881ffb63d8a5394dc55abb19d58;
$tpl->Level--;
?>
