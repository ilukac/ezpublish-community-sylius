...
$oldSetArray_0dfc640da15510d9691ca5953d029a9e = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
';
$oldRestoreIncludeArray_447d2fae19fdd9aeb5f25eedf385f095 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$vars[$currentNamespace]['i18n_hash'] = array (
  ...
  'triggers' => 'Triggers',
  'url_management' => 'Link management',
  'url_translator' => 'URL translator',
  'url_wildcards' => 'URL wildcards',
  'workflows' => 'Workflows',
  'workflow_processes' => 'Workflow processes',
  'look_and_feel' => 'Look and feel',
  'menu_management' => 'Menu management',
  'toolbar_management' => 'Toolbar management',
  'templates' => 'Templates',
);
if ( !isset( $dKeys ) )
{
...
$restoreIncludeArray = $oldRestoreIncludeArray_447d2fae19fdd9aeb5f25eedf385f095;
...
$setArray = $oldSetArray_0dfc640da15510d9691ca5953d029a9e;
$tpl->Level--;
?>
