...
$oldSetArray_245c7bc4d204ac0e25c5f318653ea639 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '  ';
unset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_153 );
unset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1531 );
unset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1531 );
$elseif_cond_af6bb285068f6883d01f24f7adda1d55_1531 = ( array_key_exists( $rootNamespace, $vars ) and array_key_exists( 'module_result', $vars[$rootNamespace] ) ) ? $vars[$rootNamespace]['module_result'] : null;
$elseif_cond_af6bb285068f6883d01f24f7adda1d55_1532 = compiledFetchAttribute( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1531, 'title_path' );
unset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1531 );
$elseif_cond_af6bb285068f6883d01f24f7adda1d55_1531 = $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1532;
if (! isset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1531 ) ) $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1531 = NULL;
while ( is_object( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1531 ) and method_exists( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1531, 'templateValue' ) )
    $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1531 = $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1531->templateValue();
while ( is_object( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1531 ) and method_exists( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1531, 'templateValue' ) )
    $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1531 = $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1531->templateValue();
$elseif_cond_af6bb285068f6883d01f24f7adda1d55_153 = isset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1531 );unset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_1531 );
if (! isset( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_153 ) ) $elseif_cond_af6bb285068f6883d01f24f7adda1d55_153 = NULL;
while ( is_object( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_153 ) and method_exists( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_153, 'templateValue' ) )
    $elseif_cond_af6bb285068f6883d01f24f7adda1d55_153 = $elseif_cond_af6bb285068f6883d01f24f7adda1d55_153->templateValue();
...
elseif ( $elseif_cond_af6bb285068f6883d01f24f7adda1d55_153 )
{
$text .= '    ';
unset( $var );
unset( $var );
...
{
$text .= '    ';
$oldRestoreIncludeArray_04ab8c92ceee004b42bc8d391a2022eb = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/canonical_link-5dc97e68bae3924c328cf5cd2aa13a2f.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/canonical_link-5dc97e68bae3924c328cf5cd2aa13a2f.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_04ab8c92ceee004b42bc8d391a2022eb;
...
{
$text .= '    ';
$oldRestoreIncludeArray_58d602050652b3c4f76ee1269915f9cf = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/link-c7a3ca87d3747900a6500554a01505c8.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/link-c7a3ca87d3747900a6500554a01505c8.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_58d602050652b3c4f76ee1269915f9cf;
...
$setArray = $oldSetArray_245c7bc4d204ac0e25c5f318653ea639;
$tpl->Level--;
?>
