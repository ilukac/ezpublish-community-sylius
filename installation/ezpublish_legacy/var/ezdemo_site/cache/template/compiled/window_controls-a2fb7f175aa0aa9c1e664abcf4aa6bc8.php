...
$oldSetArray_1a1083dd33695dc5d225a81afa574da0 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
if ( $if_cond )
{
$text .= '    <div class="button-left"><a id="maincontent-show" class="show-hide-tabs" href="/administration/user/preferences/set/admin_navigation_content/1" title="Enable &quot;Tabs&quot; by default while browsing content.">&nbsp;</a></div>';
}
else
{
$text .= '    <div class="button-left"><a id="maincontent-hide" class="show-hide-tabs" href="/administration/user/preferences/set/admin_navigation_content/0" title="Disable &quot;Tabs&quot; by default while browsing content.">&nbsp;</a></div>';
}
unset( $if_cond );
// if ends
...
$text .= '    </li>
';
$oldRestoreIncludeArray_6ff3de6b9bf60af4a8beba01f5b5c7e5 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/window_controls_extratabs-fa2823ff99e15c4209f2e5714e9d84e5.php' ) )
{
$resourceFound = true;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/window_controls_extratabs-fa2823ff99e15c4209f2e5714e9d84e5.php' );
...
$restoreIncludeArray = $oldRestoreIncludeArray_6ff3de6b9bf60af4a8beba01f5b5c7e5;
...
$text .= '<div class="tabs-content">
    ';
$oldRestoreIncludeArray_b0ec35a78ed35211767e319cd04994a2 = isset( $restoreIncludeArray ) ? $restoreIncludeArray : array();
$restoreIncludeArray = array();
...
$resourceFound = false;
if ( file_exists( 'var/ezdemo_site/cache/template/compiled/windows-e0549650a4f67e51e430f9a68f188741.php' ) )
{
$resourceFound = true;
$namespaceStack[] = array( $rootNamespace, $currentNamespace );
$rootNamespace = $currentNamespace;
...
include( '' . 'var/ezdemo_site/cache/template/compiled/windows-e0549650a4f67e51e430f9a68f188741.php' );
$tpl->unsetLocalVariables();
$tpl->destroyLocalVariablesList();
list( $rootNamespace, $currentNamespace ) = array_pop( $namespaceStack );
}
...
$restoreIncludeArray = $oldRestoreIncludeArray_b0ec35a78ed35211767e319cd04994a2;
...
$setArray = $oldSetArray_1a1083dd33695dc5d225a81afa574da0;
$tpl->Level--;
?>
