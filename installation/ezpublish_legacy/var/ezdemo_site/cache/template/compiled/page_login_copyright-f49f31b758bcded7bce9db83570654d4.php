...
$oldSetArray_4d01537868b64d093bc794fd02a04243 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$var = strtr( ' <a href="%ezpublish_link">eZ Publish</a> Copyright &copy; 1999-2014 <a href="%ez_link">eZ Systems AS</a> and others.', $var3 );
...
$setArray = $oldSetArray_4d01537868b64d093bc794fd02a04243;
$tpl->Level--;
?>
