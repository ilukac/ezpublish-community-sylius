...
$oldSetArray_d3664d1bf3e3f9dc7c1e98eef0c77f76 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
//menuArray[\'ContextMenu\'][\'elements\'][\'menu-view\'] = { \'url\': "/administration/content/view/full/%nodeID%" };
menuArray[\'ContextMenu\'][\'elements\'][\'menu-edit\'] = { \'url\': "/administration/content/edit/%objectID%" };
menuArray[\'ContextMenu\'][\'elements\'][\'menu-copy\'] = { \'url\': "/administration/content/copy/%objectID%" };
menuArray[\'ContextMenu\'][\'elements\'][\'menu-copy-subtree\']= { \'url\': "/administration/content/copysubtree/%nodeID%" };
...
$setArray = $oldSetArray_d3664d1bf3e3f9dc7c1e98eef0c77f76;
$tpl->Level--;
?>
