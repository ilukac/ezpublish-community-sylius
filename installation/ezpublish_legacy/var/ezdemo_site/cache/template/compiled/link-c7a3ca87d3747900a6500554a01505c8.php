...
$oldSetArray_b99310679b73cf4375740ab52f013b31 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
$text .= '
<link rel="Home" href="/administration" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
$text .= '" />
<link rel="Index" href="/administration" />
<link rel="Top"  href="/administration" title="';
unset( $var );
unset( $var );
...
$text .= '" />
<link rel="Search" href="/administration/content/advancedsearch" title="';
unset( $var );
unset( $var1 );
unset( $var3 );
unset( $var4 );
...
<link rel="Copyright" href="/administration/ezinfo/copyright" />
<link rel="Author" href="/administration/ezinfo/about" />
<link rel="Alternate" type="application/rss+xml" title="RSS" href="/administration/rss/feed/my_feed" />
';
// if begins
unset( $if_cond );
unset( $if_cond );
...
$setArray = $oldSetArray_b99310679b73cf4375740ab52f013b31;
$tpl->Level--;
?>
