...
$oldSetArray_8d3b807f3b69aaf8d175709a9dce95f4 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
menuArray[\'SubitemsContextMenu\'][\'elements\'][\'child-menu-multiupload\'][\'url\'] = "/administration/ezmultiupload/upload/%nodeID%";
</script>

<a id="child-menu-multiupload" href="#" onmouseover="ezpopmenu_mouseOver( \'ContextMenu\' )" >Upload multiple files</a>
';

$setArray = $oldSetArray_8d3b807f3b69aaf8d175709a9dce95f4;
$tpl->Level--;
?>
