...
$oldSetArray_e7e41ee0a27d1a6df6cc53c0dfea2f38 = isset( $setArray ) ? $setArray : array();
$setArray = array();
$tpl->Level++;
if ( $tpl->Level > 40 )
{
...
<form name="statesform" method="post" action="/administration/state/assign">
...
unset( $var2 );
unset( $var3 );
$var3 = ( '<a href=' . '"/administration/state/groups"' . '>' );
if (! isset( $var3 ) ) $var3 = NULL;
while ( is_object( $var3 ) and method_exists( $var3, 'templateValue' ) )
    $var3 = $var3->templateValue();
...
$setArray = $oldSetArray_e7e41ee0a27d1a6df6cc53c0dfea2f38;
$tpl->Level--;
?>
